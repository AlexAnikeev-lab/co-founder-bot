...
- 🌐 Автоперевод анкеты в знакомствах на английский (краткое/полное описание и сильные стороны для пользователей с интерфейсом EN)
...
5. **Заполнение профиля** - имя и фото
...
- **deep-translator** - перевод анкет в разделе знакомств для EN-интерфейса
...
2. Проходит регистрацию успешно
3. Заполняет профиль
4. Проходит тесты
