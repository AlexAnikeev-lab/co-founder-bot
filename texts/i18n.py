...
<i>Названия стартапов и проектов указывай в кавычках «…» — они не будут переводиться.</i>""",
        ...
        "compat_suffix_very_close": "очень близко",
        "compat_suffix_some_diff": "есть отличия",
        "compat_suffix_different": "разный подход",
        "compat_roles_same": "Вы оба — <b>{role}</b>. Такие люди быстрее находят общий язык.",
        "compat_roles_diff": "Вы — <b>{role_a}</b>, он(а) — <b>{role_b}</b>. Разные роли часто дополняют друг друга.",
        "compat_penalty_ethics": "ценностям",
        "compat_penalty_goals": "целям",
        "compat_penalty_risk": "риску",
        "compat_penalty_comm": "коммуникации",
        "compat_penalty_decision": "решениям",
        "compat_penalty_intro": "Отличия по: {factors}. Итоговый балл немного снижен.",
        ...
        "test_prev_question_btn": "⬅️ Предыдущий вопрос",
...
<b>Правило:</b> проблема, которую чувствуют многие, — уже возможность. Не обязательно придумывать «гениальное» — достаточно честно решить то, что мешает людям (или тебе).""",
        ...
        "events_pair_boom_title": "💥 <b>БУУУМ!</b>",
        "events_pair_boom_text": "Мы подобрали тебе пару для нетворкинга на мероприятии!",
        "events_pair_compatibility": "Совместимость",
        "events_pair_more_empty": "Дополнительной информации пока нет.",
    },
    "en": {
...
<i>Put startup and project names in quotes «…» — they won't be translated.</i>""",
        ...
        "compat_section_summary": "📌 Summary",
        "compat_factor_ethics": "Values and ethics",
        "compat_factor_goals": "Goals and motivation",
        "compat_factor_risk": "Risk attitude",
        "compat_factor_decision": "Decision-making",
        "compat_factor_comm": "Communication",
        "compat_suffix_very_close": "very close",
        "compat_suffix_some_diff": "some differences",
        "compat_suffix_different": "different approach",
        "compat_roles_same": "You are both <b>{role}</b>. People like this usually connect faster.",
        "compat_roles_diff": "You are <b>{role_a}</b>, and they are <b>{role_b}</b>. Different roles often complement each other.",
        "compat_penalty_ethics": "values",
        "compat_penalty_goals": "goals",
        "compat_penalty_risk": "risk attitude",
        "compat_penalty_comm": "communication",
        "compat_penalty_decision": "decision-making",
        "compat_penalty_intro": "Differences in: {factors}. The final score is slightly reduced.",
        "compat_summary_high": "High compatibility — your test profiles fit each other well.",
        "compat_summary_mid": "Good compatibility: you have common ground, and differences can be managed.",
        "compat_summary_low": "Moderate compatibility: your test profiles differ a lot, but collaboration is still possible.",
        ...
        "test_prev_question_btn": "⬅️ Previous question",
...
<b>Rule:</b> a problem that many people feel is already an opportunity. You don’t need a “genius” idea — just honestly solve what bothers people (or you).""",
        ...
        "events_pair_boom_title": "💥 <b>BOOM!</b>",
        "events_pair_boom_text": "We found you a networking match for the event!",
        "events_pair_compatibility": "Compatibility",
        "events_pair_more_empty": "No extra details yet.",
    },
}
