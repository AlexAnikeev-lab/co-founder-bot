...
ADMIN_CLEAR_SWIPES_CONFIRM = (
    "⚠️ <b>Очистить все свайпы?</b>\n\n"
    "Будут удалены <b>все</b> записи: лайки, дизлайки, пропуски и закладки. "
    "Действие нельзя отменить."
)
ADMIN_CLEAR_SWIPES_DONE = "✅ Удалено записей (все свайпы): <b>{count}</b>"
ADMIN_CLEAR_SWIPES_CANCELLED = "❌ Очистка отменена."

ADMIN_PREMIUM_GIVE_CONFIRM = (
    "⚠️ <b>Выдать премиум-подписку этому пользователю?</b>\n\n"
    "Пользователь получит все преимущества премиум-доступа. Продолжить?"
)
ADMIN_PREMIUM_REMOVE_CONFIRM = (
    "⚠️ <b>Снять премиум-подписку с этого пользователя?</b>\n\n"
    "Подписка будет отключена, доступ к премиум-функциям пропадёт. Продолжить?"
)
ADMIN_PREMIUM_GIVE_DONE = "✅ Премиум-подписка выдана пользователю."
ADMIN_PREMIUM_REMOVE_DONE = "✅ Премиум-подписка снята с пользователя."
